...
export default function StrategieSessionCTA({
  ...
  subtitle = 'Ontdek binnen 30 minuten hoe jij onafhankelijk kunt worden van offerte-sites.',
  benefits = [
  ...
  return (
    <section className="relative isolate overflow-hidden py-16 md:py-24 bg-section">
      ...
      <div className="mx-auto max-w-4xl px-6">
        {/* Title */}
        <h2 className="mx-auto max-w-3xl text-center type-h2 mb-4" dangerouslySetInnerHTML={{ __html: title }} />
          ...
          <div className="grid gap-6">
            ...
            <div className="mx-auto w-full max-w-2xl">
              <Button
                ...
                aria-label="Plan hypotheek strategiesessie"
              >
                {/* Shine sweep */}
              ...
              <p className="mt-3 text-center type-caption text-[var(--color-text-muted)]">
                30 min • Volledig vrijblijvend • Beperkte plaatsen
              </p>
            </div>
          </div>
        </div>
