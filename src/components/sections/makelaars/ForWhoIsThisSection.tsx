...
import { CheckCircle2, X, Target, TrendingUp, Users, Zap, CheckCircle, XCircle } from "lucide-react";

export interface ForWhoIsThisSectionProps {
  kicker?: string;
  title?: string;
  subtitle?: string;
  perfectFor?: string[];
...
export default function ForWhoIsThisSection({
    ...
    <section className="relative overflow-hidden py-16 md:py-24 pt-[84px] md:pt-[120px] pb-[96px] md:pb-[132px] bg-[radial-gradient(60%_70%_at_15%_15%,color-mix(in_oklab,var(--brand-400)_14%,transparent),transparent_70%),radial-gradient(60%_70%_at_85%_85%,color-mix(in_oklab,var(--brand-600)_12%,transparent),transparent_70%),linear-gradient(180deg,var(--brand-300-soft)_0%,var(--brand-400-soft)_100%)]">
      ...
      <div className="absolute inset-0 opacity-[0.04] [mask-image:radial-gradient(70%_70%_at_50%_40%,var(--neutral-900),transparent)]">
        <svg className="h-full w-full" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect width="100%" height="100%" fill="url(#voor-wie-grid)" className="text-black" />
        </svg>
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid lg:grid-cols-1 gap-8 md:gap-12 max-w-3xl mx-auto">

            {/* Perfect Voor */}
            <div className="bg-black/[0.04] border border-[var(--brand-400)]/20 rounded-xl p-8 md:p-12 relative overflow-hidden">
            ...
            {/* Niet geschikt voor */}
            <div className="bg-black/[0.04] border border-red-500/20 rounded-xl p-8 md:p-12 relative overflow-hidden">
              <div className="absolute inset-x-0 top-0 h-[4px] bg-gradient-to-r from-red-500 via-red-400 to-red-500" />

              <div className="mb-6">
                <h3 className="text-xl font-bold text-black mb-2">{notForTitle}</h3>
              </div>
