/**
 * Fix ONLY the FAQ section phoneNumber in Homepage
 * Run with: pnpm tsx scripts/fix-faq-homepage.ts
 */
...
async function migrate() {
  ...
  console.log(`🚀 Fixing FAQ phoneNumber in Homepage...\n`)
  ...
  try {
    ...
    const updatedNlBlocks = nlVersion.blocks?.map((block: any) => {
      if (block.blockType === 'faqSection' && 'phoneNumber' in block) {
