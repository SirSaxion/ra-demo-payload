/**
 * Fix Homepage - Complete Data Migration
 * Adds all missing content from ra-demo to ra-demo-payload
 */
...
async function fixHomepage() {
  console.log('🔧 Fixing homepage with complete data...\n')
  ...
  try {
    ...
    // Update the homepage with complete data
    const updatedPage = await payload.update({
      ...
      data: {
        ...
        blocks: [
          ...
          // 3. Problem Section (FIXED - added subtitle and items)
          {
          ...
          // 4. Case Study (FIXED - added image)
          {
            blockType: 'caseStudy',
            kicker: 'CASE STUDY',
          ...
          // 7. Marketing Machine (FIXED - added images)
          {
          ...
          // 9. Target Groups Photos (FIXED - added images)
          {
    ...
    console.log('\n🎉 Homepage is now complete with all data from ra-demo!\n')
